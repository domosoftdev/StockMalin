...
class ShoppingListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l.shoppingList), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 0),
        ...
        itemBuilder: (ctx, i) {
          if (i == items.length) {
            return ElevatedButton(
              ...
              onPressed: () {},
              child: Text("+ ${l.addItem}", style: TextStyle(color: Colors.white)),
            );
          }
          final p = items[i];
          return ListTile(
